    ...
    createCourseICal(false, function(cal, allsectionscal) {
        $(document).ready(function() {
            $('#calendar').fullCalendar({
                header: {
                    left: 'prev,next', center: 'title', right: 'basicWeek,agendaWeek,listWeek, download'
                },
                buttonText: {
                    basicWeek: 'Compact',
                    agendaWeek: 'Week',
                ...
                customButtons: {
                    download: {
                        ...
                        click: function() { return allsectionscal.download(Course.slug + "-calendar"); },
                    }
                },
                ...
                eventRender: function(event, element) { 
                    ...
                    if (event.title.toLowerCase().contains("exam")) { element.addClass("fc-exam"); }
                    else if (event.title.toLowerCase().contains("lecture")) { element.addClass("fc-lecture"); }
                    else if (event.title.toLowerCase().contains("section")) { element.addClass("fc-section"); }
                    ...
                    else { element.addClass("fc-other"); }
                ...
                validRange: {
                    ...
                    end: moment.max(Course.lastDate, Course.Exams.all[Course.Exams.all.length - 1].date).add(1, 'day')
                },
                minTime: "09:00:00",
                maxTime: "20:00:00"
            });
