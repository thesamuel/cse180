...
function ICS(PRODID) {
	...
	this.addEvent = function(options){
        ...
        } else if (Object.prototype.toString.call(options.DTSTART) == '[object String]'){
		    currentEvent += "DTSTART;"+options.DTSTART+"\n"; 
		}else{
        ...
        if((typeof options.ATTENDEE !== 'undefined') && typeof options.ATTENDEE.length  !== 'undefined'){
            for (var i = 0; i < options.ATTENDEE.length; i++) {
			    currentEvent += "ATTENDEE;"+options.ATTENDEE[i]+"\n";
            }
		}
