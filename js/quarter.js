...
// TODO: update this with real information
Course.Staff = [
    ...
    Times: {
        ...
        friday: [
            ...
            {from: "12:30pm", to: "1:30pm", who: "wottol", exceptions: ["11/10/17", "11/24/17"]},
            {
                ...
                who: "jhsia",
                location: "CSE 438",
                exceptions: ["11/3/17", "11/10/17", "11/24/17"]
            },
...
Course.Events = [
    ...
    {
        name: "Midterm Office Hours",
        location: "CSE 438",
        start: "10/29/17 6:30pm",
        end: "10/29/17 8:30pm",
        exceptions: []
    },
    {
        name: "Midterm Office Hours",
        location: "CSE 438",
        start: "10/30/17 10:30am",
        end: "10/30/17 12:30pm",
        exceptions: []
    },
    {
        name: "Midterm Office Hours",
        location: "CSE 438",
        start: "10/30/17 2:30pm",
        end: "10/30/17 3:30pm",
        exceptions: []
    },
    {name: "Special Office Hours", location: "CSE 438", start: "11/3/17 1:30pm", end: "11/3/17 2:20pm", exceptions: []},
    {
        ...
        location: "2nd Floor Breakout",
        start: "11/9/17 4:30pm",
        end: "11/9/17 5:30pm",
        exceptions: []
    },
    {
        name: "Special Office Hours",
        location: "CSE 007",
        start: "11/15/17 9:30am",
        end: "11/15/17 10:30am",
        exceptions: []
    },
    {
        name: "Special Office Hours",
        location: "3rd Floor Breakout",
        start: "11/15/17 12:30pm",
        end: "11/15/17 1:30pm",
        exceptions: []
    },
    {
        name: "Final Office Hours",
        location: "CSE 438",
        start: "12/11/17 10:30am",
        end: "12/11/17 11:30am",
        exceptions: []
    },
